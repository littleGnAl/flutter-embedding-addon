...
class AddonFlutterViewController: UIViewController {
  ...
  func providerSplashViewControler() -> UIViewController? {
    return nil
  }
  
  func configureFlutterEngine(engine: FlutterEngine) -> Void {

  }
  
  func setFlutterViewDidRenderCallback(callback: @escaping () -> Void) {
